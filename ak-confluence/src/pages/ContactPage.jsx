            ...
            <div className="rounded-2xl bg-white/70 border border-[#383838]/5 p-6">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  ...
                  {error && (
                    <p className="font-[var(--font-body)] text-[#c0563f] text-xs font-light -mt-1" role="alert">
                      {error}
                    </p>
                  )}
                  <button type="submit" disabled={sending} className="btn-primary uppercase text-[10px] tracking-[0.2em] px-6 py-3 self-start disabled:opacity-60 disabled:cursor-not-allowed">
